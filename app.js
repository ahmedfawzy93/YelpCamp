...
// mongoose.connect("mongodb+srv://afawzy:yelpyc2mpyd2t2@cluster0-chvov.mongodb.net/yelp_camp?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true }).then(function(){
// 	console.log("Connected to DB");
// }). catch (err => {
// 	console.log("ERROR:", err.message)	
// });
